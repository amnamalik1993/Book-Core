...
INSERT INTO `books` VALUES (1,'The Shining','1'),(2,'It','1'),(3,'The Great Gatby','2'),(4,'The Call','3'),(5,'Pride and Prejudice','4'),(6,'Frankenstein','5');
...
CREATE TABLE `user_has_books` (
  ...
  KEY `fk_User_has_Books_Books1_idx` (`Books_id`),
  KEY `fk_User_has_Books_User_idx` (`User_Id`),
  CONSTRAINT `fk_User_has_Books_Books1` FOREIGN KEY (`Books_id`) REFERENCES `books` (`id`),
  CONSTRAINT `fk_User_has_Books_User` FOREIGN KEY (`User_Id`) REFERENCES `user` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-05-06 19:38:14
